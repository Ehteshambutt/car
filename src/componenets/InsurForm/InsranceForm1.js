    ...
    return (
        <>
            <div className='bod'>
                ...
                <div class="bg-img"><button type="butto" class="sp text-light border-0">Car Insurance</button>
                    <form action="/action_page.php" class="contais cc position-absolute top-50 start-50 translate-middle">
                        ...
                        <button type="submit" class="blt text-center  mt-3">See More</button>
                    </form>
                </div>
            </div></>
    )
